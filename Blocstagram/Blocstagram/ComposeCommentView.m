...
//  Blocstagram
//
//  Created by Waine Tam on 3/20/15.
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        // button is a subview of textView
...
// QUESTION: better to do this than create an image for button for stylized text?
...
- (void) layoutSubviews {
    ...
    if (self.isWritingComment) {
        self.textView.backgroundColor = [UIColor colorWithRed:0.933 green:0.933 blue:0.933 alpha:1]; // #eee
        ...
        self.button.backgroundColor = [UIColor colorWithRed:0.6 green:0.6 blue:0.6 alpha:1]; // #999
