...
@property (nonatomic, strong) ALAssetsLibrary *library; // entire collectino of photos and videos
@property (nonatomic, strong) NSMutableArray *groups; // array of ALAssetsGroup objects (each album in the photo lib is an ALAssetsGroup)
@property (nonatomic, strong) NSMutableArray *arraysOfAssets; // array of arrays. each nested array will contain ALAsset objects from corresponding album
...
//- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
//    
//    return cell;
//}

- (UICollectionReusableView *) collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    UICollectionReusableView *view = [collectionView dequeueReusableSupplementaryViewOfKind:(NSString *)kind withReuseIdentifier:@"reusable view" forIndexPath:indexPath];
